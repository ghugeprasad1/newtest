...
WebUI.setText(findTestObject('Object Repository/add patient test case/Page_MyCareCoverage/input_Zip Code_zip'), '8888')
...
//WebUI.setText(findTestObject('Object Repository/add patient test case/Page_MyCareCoverage/input_Email_email'), 'Test.testgmail.com')
...
TestObject emailError = new TestObject('emailError')
emailError.addProperty("xpath", ConditionType.EQUALS, "//p[contains(text(),'Please provide a valid email address.')]")

if (WebUI.verifyElementPresent(emailError, 3, FailureHandling.OPTIONAL)) {
	WebUI.comment("❌ Invalid email detected. Fixing it now...")
	
	// Clear invalid email
	WebUI.clearText(findTestObject('Object Repository/add patient test case/Page_MyCareCoverage/input_Email_email'))
	...
	WebUI.comment("✅ Email is valid. Proceeding...")
}
