...
WebUI.navigateToUrl('https://community-dev.revone.io/mcc_intake/?path=patient_info')

WebUI.click(findTestObject('Object Repository/MCC Intake/Page_MyCareCoverage - Patient Information/div_English'))

WebUI.click(findTestObject('Object Repository/MCC Intake/Page_MyCareCoverage - Patient Information/div_English'))

WebUI.click(findTestObject('Object Repository/MCC Intake/Page_MyCareCoverage - Patient Information/button_Save'))

WebUI.click(findTestObject('Object Repository/MCC Intake/Page_MyCareCoverage - Patient Information/div_reCAPTCHA_recaptcha-checkbox-border'))
