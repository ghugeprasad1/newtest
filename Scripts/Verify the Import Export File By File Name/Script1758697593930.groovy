...
WebUI.setText(findTestObject('Object Repository/MCC_Portal_2/Import Export/Page_MyCareCoverage/input__r6'), filename)
...
if (noRecords) {
    ...
    WebUI.comment("File record found for filename:" + filename)
