...
WebUI.click(findTestObject('MCC_Portal_2/Import Export/Page_MyCareCoverage/li_Total Records'))

// Set filename from variable - make sure 'filename' is defined
WebUI.setText(findTestObject('Object Repository/MCC_Portal_2/Import Export/Page_MyCareCoverage/input__r6'), TotalRecords)
...
if (noRecords) {
    WebUI.comment('No records found for filename:' + TotalRecords)

    WebUI.comment('File count: 0' // Get pagination text and extract count
        )
} else {
    WebUI.comment('File record found for filename:' + TotalRecords)
