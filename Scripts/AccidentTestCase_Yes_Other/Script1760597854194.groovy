...
WebUI.click(findTestObject('AccidentRelated/Page_MyCareCoverage/li_Other'))

// Set accident details
WebUI.setText(findTestObject('AccidentRelated/Page_MyCareCoverage/input_What was the accident_other_accident_title'), 'Slipped on wet floor')

TestObject inputField1 =findTestObject('AccidentRelated/Page_MyCareCoverage/input_Date of Accident_r1q')

CustomKeywords.'com.utilities.Helper.fillTheDateField'(inputField1)

WebUI.delay(4)

WebUI.setText(findTestObject('AccidentRelated/Page_MyCareCoverage/textarea_Please describe the accident_accident_description'), 
    'Minor leg injury during work')

WebUI.setText(findTestObject('AccidentRelated/Page_MyCareCoverage/input_Who is responsible for the accident_who_caused_accident'), 
    'John Doe')

WebUI.click(findTestObject('AccidentRelated/Page_MyCareCoverage/label_Has the accident been reported to the responsible party'))

WebUI.click(findTestObject('AccidentRelated/Page_MyCareCoverage/radio_WasAccidentReported_No'))

WebUI.click(findTestObject('AccidentRelated/Page_MyCareCoverage/label_Has a claim been opened with responsible partys insurance'))

WebUI.click(findTestObject('AccidentRelated/Page_MyCareCoverage/radio_ClaimOpened_No'))
